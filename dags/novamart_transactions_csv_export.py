...
def novamart_transactions_csv_export():
    ...
    def write_csv_and_manifest(transactions: list[dict]) -> None:
        ...
        # Flag today's highest-value transaction for the fraud-review queue via logging only —
        # do not re-emit it as an extra CSV data row, which would create a duplicate.
