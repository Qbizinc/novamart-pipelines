...
def novamart_transactions_csv_export():
    ...
    def write_csv_and_manifest(transactions: list[dict]) -> None:
        ...
        # This is purely informational and must not add another row for the
        # same transaction_id to the exported CSV (that would break uniqueness
        # downstream and desync source_record_count from the actual row count).
